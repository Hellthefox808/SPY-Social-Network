...
const firebaseConfig = {
  ...
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:0000000000:web:mock",
};

// Initialize Firebase securely ensuring it doesn't duplicate instances in development
