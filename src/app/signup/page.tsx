...
import { Network, Eye, EyeOff, Loader2, ArrowRight, CheckCircle2, AlertTriangle, Github, ShieldCheck } from "lucide-react";
    ...
    >
      ...
      >
        <div className="flex flex-col items-center text-center space-y-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 flex items-center justify-center gap-1.5">
              <ShieldCheck className="h-3.5 w-3.5 text-blue-400" /> Join SocialGraph Atlas OSINT Platform
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          <div>
            <label htmlFor="signup-name" className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">
              Full Name
            </label>
            <input
              id="signup-name"
            ...
            />
            {!isNameValid && (
              <p className="mt-1 text-[11px] text-red-400">Please enter at least 2 characters.</p>
            )}
          </div>

          <div>
            <label htmlFor="signup-email" className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">
              Email Address
            </label>
            <input
              id="signup-email"
        ...
        <div className="grid grid-cols-2 gap-2.5 mt-3">
          <button
            ...
            onClick={() => {
              setName("Demo User");
              setEmail("demo@socialgraph.local");
        ...
        <p className="mt-5 text-[10px] text-slate-500 text-center leading-relaxed border-t border-slate-900/90 pt-4">
          By registering, you agree to SocialGraph Atlas's{" "}
